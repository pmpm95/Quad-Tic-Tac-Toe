...
* 초기엔 항상 'X'가 선공이었고, 게임을 초기화 해도 'X'의 선공으로 시작했습니다. (12번째 줄)
* 초기에는 3x3 보드 3목게임(Tic Tac Toe)으로 구현했었습니다. (17번째 줄)
* Flexbox를 활용하여 랜더링 되는 부분을 개선했습니다.(71번째 줄)
* Tic Tac Toe로 구현했을 당시에는 승리 조건을 보드판안의 모든 경우의 수를 대입해보는 것으로 구현했습니다. (201번째 줄)
